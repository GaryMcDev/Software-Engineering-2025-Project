window.onload = async function() {
    ...
    if (!deviceID) {
        showError("No device found. Please check your connection and try again.");
        return;
    }
    ...
    setInterval(async () => {
        ...
        if (deviceData) {
            ...
            if (internalTemp !== "N/A" && externalTemp !== "N/A") {
                addData(elapsedTime.toString(), internalTemp, externalTemp);
            }
            ...
            // Hide any error message if data is successfully retrieved
            hideError();
        } else {
